 ...
 */
extern "C" computer	cname_to_comp(char *cname);
 ...
 */
extern "C" connection	await_contact(appnum a);
 ...
 */
extern "C" connection	make_contact(computer c, appnum a);
 ...
 */
extern "C" int		end_contact(connection c);
 ...
 */
extern "C" int		get_server_socket(appnum a);
